 ...
 *
 * @version v0.1.0
 * @link https://github.com/nnajm/orb
 * @license MIT
 */
  ...
  return (function e(t, n, r) {
      ...
      module.exports = function (columnsAxe) {
        ...
        function generateLeafsHeaders() {
          ...
          if (self.uiInfos.length > 0) {
            ...
            var currparent, prevpar = header.parent;
        ...
        function getUiInfo(depth, uiInfos) {
          ...
          var parents = self.axe.root.depth === depth ? [null] : uiInfos[self.axe.root.depth - depth - 1].filter(function (p) {
    ...
    8: [function (_dereq_, module, exports) {
      ...
      function CellBase(options) {
        ...
        this.hspan = options.hspan ||
        function () {
          return 1;
        };

        this.vspan = options.vspan ||
        function () {
          return 1;
        };
      ...
      module.exports.dataCell = function (pgrid, isvisible, rowinfo, colinfo) {
        ...
        var datafield = pgrid.config.dataFieldsCount > 1 ? (pgrid.config.dataHeadersLocation === 'rows' ? rowinfo.value : colinfo.value) : pgrid.config.dataFields[0];
    ...
    12: [function (_dereq_, module, exports) {
      ...
      module.exports.PivotTable = React.createClass({
        ...
        render: function () {
          ...
          React.createElement("div", {
            ...
            className: "field-group-caption"
          }, "Data fields:")), React.createElement("td", {
            className: "empty",
            colSpan: ptc.totalWidth,
            rowSpan: "1"
          }, React.createElement(DropTarget, {
      ...
      module.exports.PivotRow = React.createClass({
        ...
        render: function () {
          ...
          if (this.props.rowButtonsCell !== undefined) {
            ...
            return (
            React.createElement("tr", null, this.props.rowButtonsCell, cells));
            ...
            cells = this.props.row.map(function (cell, index) {
              ...
              cell.type === uiheaders.HeaderType.EMPTY || cell.type === uiheaders.HeaderType.SUB_TOTAL || cell.type === uiheaders.HeaderType.GRAND_TOTAL || (cell.dim && (cell.dim.isRoot || cell.dim.parent.isRoot)));
      ...
      module.exports.PivotCell = React.createClass({
        ...
        render: function () {
          ...
          return React.createElement("td", {
            ...
            rowSpan: cell.vspan()
          }, React.createElement("div", null, divcontent));
        }
      });
            ...
            if (_dragElement != null) {
              ...
              if (foundTarget) {
                forEach(_dropIndicators, function (indicator, index) {
                  if (!foundIndicator) {
                    var elementOwnIndicator = indicator.component.props.axetype === _dragElement.props.axetype && indicator.component.props.position === _dragElement.props.position;
          ...
          var buttons = this.props.data.map(function (button, index) {
            if (index < self.props.data.length - 1) {
              ...
              React.createElement(DropIndicator, {
                ...
                position: index,
                axetype: self.props.axetype
              }), button, React.createElement(DropIndicator, {
                isLast: true,
                position: null,
                axetype: self.props.axetype
              })];
      ...
      module.exports.PivotButton = React.createClass({
        ...
        render: function () {
          ...
          var DropIndicator = module.exports.DropIndicator;
          var sortIndicator = self.props.field.sort.order === 'asc' ? ' \u25B3' : (self.props.field.sort.order === 'desc' ? ' \u25BD' : '');
          ...
          return React.createElement("div", {
            ...
            style: divstyle
          }, self.props.field.caption, React.createElement("span", null, sortIndicator));
        }
      });
    },
    {
